...
Every test starts fresh and bypasses all transcription journals. Daily request accounting still applies. See [testing](../../docs/testing.md) for how to point the program here, compare runs, and curate a separate reviewed regression baseline in future work.
